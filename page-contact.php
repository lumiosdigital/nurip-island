    ...
    <section class="contact-hero">
        <div class="contact-container">
            ...
            <h1 class="contact-title">
                <?php echo esc_html(get_theme_mod('nirup_contact_title', 'CONTACT US')); ?>
            </h1>
            ...
            <div class="contact-info-text">
                ...
                <p><?php echo esc_html(get_theme_mod('nirup_contact_closing_text', 'For all other requests, please complete the enquiry form below. Our team will review your message and respond within 1-2 business days.')); ?></p>
            </div>
            ...
            <form id="contact-form" class="contact-form">
                ...
                <div class="form-field">
                    <label for="contact-name" class="form-label">
                        <?php echo esc_html(get_theme_mod('nirup_contact_label_name', 'Name*')); ?>
                    </label>
                    <input 
                        type="text" 
                        id="contact-name" 
                        name="name" 
                        class="form-input" 
                        placeholder="<?php echo esc_attr(get_theme_mod('nirup_contact_placeholder_name', 'Your Name')); ?>" 
                        required
                    >
                </div>
                ...
                <div class="form-field">
                    <label for="contact-email" class="form-label">
                        <?php echo esc_html(get_theme_mod('nirup_contact_label_email', 'E-mail*')); ?>
                    </label>
                    <input 
                        type="email" 
                        id="contact-email" 
                        name="email" 
                        class="form-input" 
                        placeholder="<?php echo esc_attr(get_theme_mod('nirup_contact_placeholder_email', 'Your E-mail')); ?>" 
                        required
                    >
                </div>
                ...
                <div class="form-field">
                    <label for="contact-inquiry-type" class="form-label">
                        <?php echo esc_html(get_theme_mod('nirup_contact_label_inquiry', 'Type of Enquiry*')); ?>
                    </label>
                    <div class="custom-select-wrapper">
                        <select id="contact-inquiry-type" name="inquiry_type" class="form-select" required>
                            <option value="" disabled selected>
                                <?php echo esc_html(get_theme_mod('nirup_contact_placeholder_inquiry', 'Choose event type')); ?>
                            </option>
                ...
                <div class="form-field form-field-message">
                    <label for="contact-message" class="form-label">
                        <?php echo esc_html(get_theme_mod('nirup_contact_label_message', 'Message*')); ?>
                    </label>
                    <textarea 
                        id="contact-message" 
                        name="message" 
                        class="form-textarea" 
                        placeholder="<?php echo esc_attr(get_theme_mod('nirup_contact_placeholder_message', 'Text your message here')); ?>" 
                        rows="5" 
                        required
                    ></textarea>
                </div>
                ...
                <button type="submit" class="contact-submit-btn">
                    <span class="btn-text">
                        <?php echo esc_html(get_theme_mod('nirup_contact_submit_text', 'Submit Inquiry')); ?>
                    </span>
...
<div id="thank-you-modal" class="thank-you-modal">
    ...
    <div class="modal-content">
        <h2 class="modal-title">
            <?php echo esc_html(get_theme_mod('nirup_contact_modal_title', 'THANK YOU!')); ?>
        </h2>
        <p class="modal-text">
            <?php echo esc_html(get_theme_mod('nirup_contact_modal_message_1', 'Your request has been received.')); ?><br>
            <?php echo esc_html(get_theme_mod('nirup_contact_modal_message_2', 'Our team is at your service')); ?>
        </p>
        <div class="modal-contact">
            ...
            <span><?php echo esc_html(get_theme_mod('nirup_contact_modal_phone_text', 'For urgent matters, call')); ?> 
