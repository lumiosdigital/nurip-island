...
jQuery(document).ready(function($) {
    ...
    // Track individual service card clicks/interactions
    $('.service-card').on('click', function(e) {
        const serviceType = $(this).data('service');
        const hasLink = $(this).hasClass('service-card-linked');
        ...
        // For cards without links, we can add custom behavior here if needed
        if (!hasLink) {
            // Example: could show a modal, scroll to a section, etc.
