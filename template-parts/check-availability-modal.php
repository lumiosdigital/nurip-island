...
<div id="check-availability-modal" class="check-availability-modal" aria-hidden="true" role="dialog">
    ...
    <div class="check-availability-container" role="document">
        ...
        <div class="check-availability-content">
            ...
            <!-- Note above Check-in / Check-out -->
            <p class="check-availability-note">
                This calendar is exclusively for Riahi Residences villa bookings.
            </p>

            <div class="check-availability-form-block">
                <?php
                ...
                if ( shortcode_exists( 'wpbs-search' ) ) {
                     ...
                     *   instead of showing results below the widget (we hide any leftovers with CSS).
                     */
                    $shortcode = sprintf(
            ...
            <!-- Little link below search section -->
            <p class="check-availability-aux-link">
                <a href="#" class="check-availability-aux-link__anchor">
                    Book at The Westin 
